...
var ng2_dragula_d_1 = require('../../../node_modules/ng2-dragula/ng2-dragula.d');
...
var ScaleWebApplication = (function () {
    ...
    ScaleWebApplication.makeSomeBoxes = function (n) {
        var result = [];
        for (var i = 0; i < n; i++) {
    ...
    ScaleWebApplication = __decorate([
        core_1.Component({
            selector: 'web-scale',
            viewProviders: [ng2_dragula_d_1.DragulaService],
            templateUrl: './app/scaleWebApplication.html',
            styleUrls: ['./app/scaleWebApplication.css'],
            directives: [[ng2_dragula_d_1.Dragula]]
        }), 
        __metadata('design:paramtypes', [ng2_dragula_d_1.DragulaService])
    ], ScaleWebApplication);
